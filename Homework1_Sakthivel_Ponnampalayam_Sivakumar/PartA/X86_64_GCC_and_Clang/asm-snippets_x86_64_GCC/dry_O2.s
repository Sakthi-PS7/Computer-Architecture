...
# dry.c:807:   if (Ptr_Glob != Null)
	movq	Ptr_Glob(%rip), %rdx	# Ptr_Glob, pretmp_3
# dry.c:807:   if (Ptr_Glob != Null)
	testq	%rdx, %rdx	# pretmp_3
	je	.L2	#,
# dry.c:809:     *Ptr_Ref_Par = Ptr_Glob->Ptr_Comp;
	movq	(%rdx), %rax	# Ptr_Glob.99_26->Ptr_Comp, _27
# dry.c:809:     *Ptr_Ref_Par = Ptr_Glob->Ptr_Comp;
	movq	%rax, (%rbx)	# _27, MEM[(struct record * *)Next_Record_15]
...
# dry.c:777:     structassign (*Ptr_Val_Par, *Ptr_Val_Par->Ptr_Comp);
	...
	movdqu	(%rax), %xmm0	# *_11, *_11
	movups	%xmm0, 0(%rbp)	# *_11, *Ptr_Val_Par_14(D)
	movdqu	16(%rax), %xmm0	# *_11, *_11
	movups	%xmm0, 16(%rbp)	# *_11, *Ptr_Val_Par_14(D)
	movdqu	32(%rax), %xmm0	# *_11, *_11
	movups	%xmm0, 32(%rbp)	# *_11, *Ptr_Val_Par_14(D)
...
# dry.c:580:   Next_Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movq	%rax, %r12	#, tmp387
# dry.c:580:   Next_Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movq	%rax, Next_Ptr_Glob(%rip)	# tmp387, Next_Ptr_Glob
# dry.c:581:   Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	call	malloc	#
# dry.c:584:   Ptr_Glob->Discr                       = Ident_1;
	movq	.LC1(%rip), %rdx	#, tmp237
# dry.c:597:   printf ("\n");
	movl	$10, %edi	#,
# dry.c:587:   strcpy (Ptr_Glob->variant.var_1.Str_Comp, 
	movdqa	.LC44(%rip), %xmm0	#, tmp380
	movdqa	.LC45(%rip), %xmm1	#, tmp381
# dry.c:583:   Ptr_Glob->Ptr_Comp                    = Next_Ptr_Glob;
	movq	%r12, (%rax)	# tmp387, MEM[(struct record *)_5].Ptr_Comp
# dry.c:584:   Ptr_Glob->Discr                       = Ident_1;
	movq	%rdx, 8(%rax)	# tmp237, MEM <vector(2) unsigned int> [(void *)_5 + 8B]
# dry.c:586:   Ptr_Glob->variant.var_1.Int_Comp      = 40;
	movl	$40, 16(%rax)	#, MEM[(struct record *)_5].variant.var_1.Int_Comp
# dry.c:587:   strcpy (Ptr_Glob->variant.var_1.Str_Comp, 
	movups	%xmm0, 20(%rax)	# tmp380, MEM <char[1:31]> [(void *)_5 + 20B]
# dry.c:589:   strcpy (Str_1_Loc, "DHRYSTONE PROGRAM, 1'ST STRING");
	movaps	%xmm0, 16(%rsp)	# tmp380, MEM <unsigned char[31]> [(char * {ref-all})&Str_1_Loc]
	movdqa	.LC46(%rip), %xmm0	#, tmp383
# dry.c:587:   strcpy (Ptr_Glob->variant.var_1.Str_Comp, 
	movups	%xmm1, 35(%rax)	# tmp381, MEM <char[1:31]> [(void *)_5 + 20B]
# dry.c:589:   strcpy (Str_1_Loc, "DHRYSTONE PROGRAM, 1'ST STRING");
	movups	%xmm0, 31(%rsp)	# tmp383, MEM <unsigned char[31]> [(char * {ref-all})&Str_1_Loc]
# dry.c:581:   Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movq	%rax, Ptr_Glob(%rip)	# tmp388, Ptr_Glob
...
# dry.c:629:       strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
	movdqa	.LC44(%rip), %xmm6	#, tmp397
# dry.c:631:       Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
	leaq	48(%rsp), %rsi	#, tmp399
# dry.c:629:       strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
	movdqa	.LC47(%rip), %xmm7	#, tmp398
# dry.c:631:       Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
	leaq	16(%rsp), %rdi	#, tmp400
# dry.c:830:   Ch_1_Glob = 'A';
	movb	$65, Ch_1_Glob(%rip)	#, Ch_1_Glob
# dry.c:629:       strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
	movaps	%xmm6, 48(%rsp)	# tmp397, MEM <unsigned char[31]> [(char * {ref-all})&Str_2_Loc]
# dry.c:821:   Bool_Glob = Bool_Loc | Bool_Glob;
	movl	$1, Bool_Glob(%rip)	#, Bool_Glob
# dry.c:629:       strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
	movups	%xmm7, 63(%rsp)	# tmp398, MEM <unsigned char[31]> [(char * {ref-all})&Str_2_Loc]
...
# dry.c:652: 	  strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 3'RD STRING");
	movdqa	.LC44(%rip), %xmm4	#, tmp403
	movdqa	.LC48(%rip), %xmm5	#, tmp404
# dry.c:654: 	  Int_Glob = Run_Index;
	movl	%ebp, Int_Glob(%rip)	# Run_Index, Int_Glob
# dry.c:645:       for (Ch_Index = 'A'; Ch_Index <= Ch_2_Glob; ++Ch_Index)
	cmpb	%bl, Ch_2_Glob(%rip)	# Ch_Index, Ch_2_Glob
# dry.c:652: 	  strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 3'RD STRING");
	movaps	%xmm4, 48(%rsp)	# tmp403, MEM <unsigned char[31]> [(char * {ref-all})&Str_2_Loc]
	movups	%xmm5, 63(%rsp)	# tmp404, MEM <unsigned char[31]> [(char * {ref-all})&Str_2_Loc]
# dry.c:645:       for (Ch_Index = 'A'; Ch_Index <= Ch_2_Glob; ++Ch_Index)
	jge	.L20	#,
.L34:
# dry.c:658:       Int_2_Loc = Int_2_Loc * Int_1_Loc;
	leal	(%r12,%r12,2), %ecx	#, _272
.L18:
# dry.c:659:       Int_1_Loc = Int_2_Loc / Int_3_Loc;
	movl	%ecx, %eax	# _272, _23
...
# dry.c:705:   fprintf (stderr, "  Str_Comp:          %s\n", Ptr_Glob->variant.var_1.Str_Comp);
	movq	Ptr_Glob(%rip), %rax	# Ptr_Glob, tmp407
	movl	$.LC26, %esi	#,
	movq	stderr(%rip), %rdi	# stderr,
	leaq	20(%rax), %rdx	#, tmp305
	xorl	%eax, %eax	#
	call	fprintf	#
...
# dry.c:716:   fprintf (stderr, "  Str_Comp:          %s\n",
	movq	Next_Ptr_Glob(%rip), %rax	# Next_Ptr_Glob, tmp408
	movl	$.LC26, %esi	#,
	movq	stderr(%rip), %rdi	# stderr,
	leaq	20(%rax), %rdx	#, tmp326
	xorl	%eax, %eax	#
	call	fprintf	#
...
# dry.c:735:                         / ((float) HZ * ((float) Number_Of_Runs));
	cvtsd2ss	%xmm0, %xmm0	# _118, tmp355
	movss	%xmm0, Microseconds(%rip)	# tmp355, Microseconds
# dry.c:739:     printf ("\nMicroseconds for one run through Dhrystone: ");
	call	printf	#
