...
# options passed: -mtune=generic -march=i686 -O3 -fasynchronous-unwind-tables
	.text
	.p2align 4
	.globl	Proc_1
...
# dry.c:762:   Next_Record->Ptr_Comp = Ptr_Val_Par->Ptr_Comp;
	movl	(%edi), %edx	# Ptr_Val_Par_14(D)->Ptr_Comp, _4
# dry.c:762:   Next_Record->Ptr_Comp = Ptr_Val_Par->Ptr_Comp;
	movl	%edx, (%esi)	# _4, Next_Record_15->Ptr_Comp
# dry.c:809:     *Ptr_Ref_Par = Ptr_Glob->Ptr_Comp;
	movl	(%eax), %eax	# Ptr_Glob.95_1->Ptr_Comp, _26
# dry.c:809:     *Ptr_Ref_Par = Ptr_Glob->Ptr_Comp;
	movl	%eax, (%esi)	# _26, MEM[(struct record * *)Next_Record_15]
# dry.c:810:   Proc_7 (10, Int_Glob, &Ptr_Glob->variant.var_1.Int_Comp);
...
# dry.c:777:     structassign (*Ptr_Val_Par, *Ptr_Val_Par->Ptr_Comp);
	movl	(%edi), %eax	# Ptr_Val_Par_14(D)->Ptr_Comp, _30
	movl	(%eax), %edx	# *_30, *_30
	movl	%edx, (%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	4(%eax), %edx	# *_30, *_30
	movl	%edx, 4(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	8(%eax), %edx	# *_30, *_30
	movl	%edx, 8(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	12(%eax), %edx	# *_30, *_30
	movl	%edx, 12(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	16(%eax), %edx	# *_30, *_30
	movl	%edx, 16(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	20(%eax), %edx	# *_30, *_30
	movl	%edx, 20(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	24(%eax), %edx	# *_30, *_30
	movl	%edx, 24(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	28(%eax), %edx	# *_30, *_30
	movl	%edx, 28(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	32(%eax), %edx	# *_30, *_30
	movl	%edx, 32(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	36(%eax), %edx	# *_30, *_30
	movl	%edx, 36(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	40(%eax), %edx	# *_30, *_30
	movl	%edx, 40(%edi)	# *_30, *Ptr_Val_Par_14(D)
	movl	44(%eax), %eax	# *_30, *_30
	movl	%eax, 44(%edi)	# *_30, *Ptr_Val_Par_14(D)
# dry.c:778: } /* Proc_1 */
	popl	%ebx	#
	.cfi_remember_state
	.cfi_restore 3
...
# dry.c:773:     Proc_7 (Next_Record->variant.var_1.Int_Comp, 10, 
	...
	.cfi_def_cfa_offset 20
# dry.c:772:     Next_Record->Ptr_Comp = Ptr_Glob->Ptr_Comp;
	movl	(%eax), %eax	# Ptr_Glob.96_9->Ptr_Comp, _10
# dry.c:772:     Next_Record->Ptr_Comp = Ptr_Glob->Ptr_Comp;
	movl	%eax, (%esi)	# _10, Next_Record_15->Ptr_Comp
...
# dry.c:580:   Next_Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	...
	call	malloc@PLT	#
# dry.c:580:   Next_Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movl	%eax, Next_Ptr_Glob@GOTOFF(%ebx)	# tmp222, Next_Ptr_Glob
# dry.c:580:   Next_Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movl	%eax, %esi	# tmp414, tmp222
...
# dry.c:581:   Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
	movl	%eax, Ptr_Glob@GOTOFF(%ebx)	# tmp223, Ptr_Glob
# dry.c:583:   Ptr_Glob->Ptr_Comp                    = Next_Ptr_Glob;
	movl	%esi, (%eax)	# tmp222, MEM[(struct record *)_4].Ptr_Comp
...
# dry.c:598:   printf ("Dhrystone Benchmark, Version %s\n", Version);
	popl	%edi	#
	popl	%eax	#
	leal	.LC1@GOTOFF(%ebx), %eax	#, tmp226
	pushl	%eax	# tmp226
	leal	.LC2@GOTOFF(%ebx), %eax	#, tmp227
	pushl	%eax	# tmp227
	call	printf@PLT	#
# dry.c:599:   if (Reg)
...
# dry.c:605:     printf ("Program compiled without 'register' attribute\n");
	subl	$12, %esp	#,
	leal	.LC4@GOTOFF(%ebx), %eax	#, tmp229
	pushl	%eax	# tmp229
	call	puts@PLT	#
	addl	$16, %esp	#,
.L12:
# dry.c:607:   printf ("Using %s, HZ=%d\n", CLOCK_TYPE, HZ);
	subl	$4, %esp	#,
	leal	.LC5@GOTOFF(%ebx), %eax	#, tmp230
	pushl	$100	#
	pushl	%eax	# tmp230
	leal	.LC6@GOTOFF(%ebx), %eax	#, tmp231
	pushl	%eax	# tmp231
	call	printf@PLT	#
# dry.c:608:   printf ("\n");
	movl	$10, (%esp)	#,
	call	putchar@PLT	#
	leal	.LC7@GOTOFF(%ebx), %eax	#, tmp400
# dry.c:610:   Done = false;
	addl	$16, %esp	#,
	movl	$0, Done@GOTOFF(%ebx)	#, Done
	movl	%eax, -152(%ebp)	# tmp400, %sfp
	leal	time_info@GOTOFF(%ebx), %eax	#, tmp394
	movl	%eax, -140(%ebp)	# tmp394, %sfp
	leal	time_info@GOTOFF, %eax	#, tmp396
	movl	%eax, -144(%ebp)	# tmp396, %sfp
	leal	-55(%ebp), %eax	#, tmp399
	movl	%eax, -124(%ebp)	# tmp399, %sfp
	leal	-86(%ebp), %eax	#, tmp397
	movl	%eax, -120(%ebp)	# tmp397, %sfp
	leal	-96(%ebp), %eax	#, tmp395
	movl	%eax, -128(%ebp)	# tmp395, %sfp
	leal	Arr_2_Glob@GOTOFF(%ebx), %eax	#, tmp398
	movl	%eax, -132(%ebp)	# tmp398, %sfp
	leal	Arr_1_Glob@GOTOFF(%ebx), %eax	#, tmp401
	movl	%eax, -136(%ebp)	# tmp401, %sfp
# dry.c:651: 	  Proc_6 (Ident_1, &Enum_Loc);
	leal	-92(%ebp), %eax	#, tmp409
	movl	%eax, -112(%ebp)	# tmp409, %sfp
	.p2align 4,,10
	.p2align 3
.L21:
...
# dry.c:631:       Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
	testl	%eax, %eax	# tmp416
	sete	%al	#, tmp238
	movzbl	%al, %eax	# tmp238, tmp238
# dry.c:631:       Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
	movl	%eax, Bool_Glob@GOTOFF(%ebx)	# tmp238, Bool_Glob
...
# dry.c:648: 	if (Enum_Loc == Func_1 (Ch_Index, 'C'))
	addl	$16, %esp	#,
	cmpl	-92(%ebp), %eax	# Enum_Loc, tmp417
	je	.L32	#,
# dry.c:645:       for (Ch_Index = 'A'; Ch_Index <= Ch_2_Glob; ++Ch_Index)
	addl	$1, %edi	#, Ch_Index
# dry.c:645:       for (Ch_Index = 'A'; Ch_Index <= Ch_2_Glob; ++Ch_Index)
...
# dry.c:658:       Int_2_Loc = Int_2_Loc * Int_1_Loc;
	movl	-108(%ebp), %eax	# %sfp, Int_2_Loc
	leal	(%eax,%eax,2), %ecx	#, prephitmp_134
.L13:
# dry.c:659:       Int_1_Loc = Int_2_Loc / Int_3_Loc;
	movl	%ecx, %eax	# prephitmp_134, tmp248
...
# dry.c:679:     } else Done = true;
	...
	movl	-108(%ebp), %ecx	# %sfp, tmp248
	movl	%esi, %edx	# Int_1_Loc, Int_1_Loc
.L22:
# dry.c:682:   fprintf (stderr, "Final values of the variables used in the benchmark:\n");
	movl	stderr@GOT(%ebx), %esi	#, tmp258
	leal	.LC9@GOTOFF(%ebx), %eax	#, tmp259
	movl	%ecx, -156(%ebp)	# tmp248, %sfp
	movl	%edx, -152(%ebp)	# Int_1_Loc, %sfp
	pushl	(%esi)	# stderr
	pushl	$53	#
	pushl	$1	#
	pushl	%eax	# tmp259
...
# dry.c:684:   fprintf (stderr, "Int_Glob:            %d\n", Int_Glob);
	addl	$12, %esp	#,
	leal	.LC10@GOTOFF(%ebx), %eax	#, tmp261
	pushl	Int_Glob@GOTOFF(%ebx)	# Int_Glob
	pushl	%eax	# tmp261
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:685:   fprintf (stderr, "        should be:   %d\n", 5);
	addl	$12, %esp	#,
	leal	.LC11@GOTOFF(%ebx), %eax	#, tmp263
	pushl	$5	#
	movl	%eax, -108(%ebp)	# tmp263, %sfp
	pushl	%eax	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:686:   fprintf (stderr, "Bool_Glob:           %d\n", Bool_Glob);
	addl	$12, %esp	#,
	leal	.LC12@GOTOFF(%ebx), %eax	#, tmp265
...
# dry.c:688:   fprintf (stderr, "Ch_1_Glob:           %c\n", Ch_1_Glob);
	...
	addl	$12, %esp	#,
	pushl	%eax	# Ch_1_Glob
	leal	.LC13@GOTOFF(%ebx), %eax	#, tmp270
	pushl	%eax	# tmp270
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:689:   fprintf (stderr, "        should be:   %c\n", 'A');
	leal	.LC14@GOTOFF(%ebx), %ecx	#, tmp272
	addl	$12, %esp	#,
	pushl	$65	#
	movl	%ecx, -112(%ebp)	# tmp272, %sfp
	pushl	%ecx	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:690:   fprintf (stderr, "Ch_2_Glob:           %c\n", Ch_2_Glob);
	...
	addl	$12, %esp	#,
	pushl	%eax	# Ch_2_Glob
	leal	.LC15@GOTOFF(%ebx), %eax	#, tmp275
	pushl	%eax	# tmp275
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:692:   fprintf (stderr, "Arr_1_Glob[8]:       %d\n", Arr_1_Glob[8]);
	addl	$12, %esp	#,
	leal	.LC16@GOTOFF(%ebx), %eax	#, tmp280
...
# dry.c:696:   fprintf (stderr, "Ptr_Glob->\n");
	addl	$32, %esp	#,
	leal	.LC19@GOTOFF(%ebx), %eax	#, tmp290
	pushl	(%esi)	# stderr
	pushl	$11	#
	pushl	$1	#
	pushl	%eax	# tmp290
...
# dry.c:699:   fprintf (stderr, "  Discr:             %d\n", Ptr_Glob->Discr);
	movl	Ptr_Glob@GOTOFF(%ebx), %eax	# Ptr_Glob, Ptr_Glob
# dry.c:699:   fprintf (stderr, "  Discr:             %d\n", Ptr_Glob->Discr);
	leal	.LC22@GOTOFF(%ebx), %edx	#, tmp297
	addl	$28, %esp	#,
	pushl	4(%eax)	# Ptr_Glob.47_63->Discr
	movl	%edx, -128(%ebp)	# tmp297, %sfp
	pushl	%edx	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:701:   fprintf (stderr, "  Enum_Comp:         %d\n", Ptr_Glob->variant.var_1.Enum_Comp);
	...
	leal	.LC23@GOTOFF(%ebx), %eax	#, tmp302
	movl	%eax, -132(%ebp)	# tmp302, %sfp
	pushl	%eax	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:703:   fprintf (stderr, "  Int_Comp:          %d\n", Ptr_Glob->variant.var_1.Int_Comp);
	movl	Ptr_Glob@GOTOFF(%ebx), %eax	# Ptr_Glob, Ptr_Glob
	leal	.LC24@GOTOFF(%ebx), %ecx	#, tmp307
	addl	$12, %esp	#,
	pushl	12(%eax)	# Ptr_Glob.53_71->variant.var_1.Int_Comp
	movl	%ecx, -136(%ebp)	# tmp307, %sfp
	pushl	%ecx	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:705:   fprintf (stderr, "  Str_Comp:          %s\n", Ptr_Glob->variant.var_1.Str_Comp);
	movl	Ptr_Glob@GOTOFF(%ebx), %eax	# Ptr_Glob, Ptr_Glob
	leal	.LC25@GOTOFF(%ebx), %edx	#, tmp313
	addl	$12, %esp	#,
	addl	$16, %eax	#, tmp311
	pushl	%eax	# tmp311
	movl	%edx, -140(%ebp)	# tmp313, %sfp
	pushl	%edx	#
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:706:   fprintf (stderr, "        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
	leal	.LC26@GOTOFF(%ebx), %eax	#, tmp316
	pushl	(%esi)	# stderr
	pushl	$52	#
	pushl	$1	#
	movl	%eax, -144(%ebp)	# tmp316, %sfp
	pushl	%eax	#
	call	fwrite@PLT	#
# dry.c:707:   fprintf (stderr, "Next_Ptr_Glob->\n");
	addl	$32, %esp	#,
	leal	.LC27@GOTOFF(%ebx), %eax	#, tmp318
	pushl	(%esi)	# stderr
	pushl	$16	#
	pushl	$1	#
	pushl	%eax	# tmp318
...
# dry.c:709:   fprintf (stderr, "        should be:   (implementation-dependent), same as above\n");
	leal	.LC28@GOTOFF(%ebx), %eax	#, tmp323
	pushl	(%esi)	# stderr
	pushl	$63	#
	pushl	$1	#
	pushl	%eax	# tmp323
...
# dry.c:719:   fprintf (stderr, "Int_1_Loc:           %d\n", Int_1_Loc);
	movl	-152(%ebp), %edx	# %sfp, Int_1_Loc
	addl	$28, %esp	#,
	leal	.LC29@GOTOFF(%ebx), %eax	#, tmp345
	pushl	%edx	# Int_1_Loc
	pushl	%eax	# tmp345
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:660:       Int_2_Loc = 7 * (Int_2_Loc - Int_3_Loc) - Int_1_Loc;
	movl	-156(%ebp), %ecx	# %sfp, tmp248
# dry.c:721:   fprintf (stderr, "Int_2_Loc:           %d\n", Int_2_Loc);
	addl	$12, %esp	#,
# dry.c:660:       Int_2_Loc = 7 * (Int_2_Loc - Int_3_Loc) - Int_1_Loc;
	subl	%edi, %edx	# Int_3_Loc.18_27, prephitmp_134
# dry.c:660:       Int_2_Loc = 7 * (Int_2_Loc - Int_3_Loc) - Int_1_Loc;
	leal	0(,%edx,8), %eax	#, tmp351
	subl	%edx, %eax	# tmp349, tmp352
# dry.c:660:       Int_2_Loc = 7 * (Int_2_Loc - Int_3_Loc) - Int_1_Loc;
	subl	%ecx, %eax	# tmp248, Int_2_Loc
# dry.c:721:   fprintf (stderr, "Int_2_Loc:           %d\n", Int_2_Loc);
	pushl	%eax	# Int_2_Loc
	leal	.LC30@GOTOFF(%ebx), %eax	#, tmp354
	pushl	%eax	# tmp354
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
# dry.c:722:   fprintf (stderr, "        should be:   %d\n", 13);
	movl	-108(%ebp), %edi	# %sfp, tmp263
	addl	$12, %esp	#,
	pushl	$13	#
	pushl	%edi	# tmp263
	pushl	(%esi)	# stderr
...
# dry.c:723:   fprintf (stderr, "Int_3_Loc:           %d\n", Int_3_Loc);
	addl	$12, %esp	#,
	leal	.LC31@GOTOFF(%ebx), %eax	#, tmp358
	pushl	-96(%ebp)	# Int_3_Loc
	pushl	%eax	# tmp358
	pushl	(%esi)	# stderr
	call	fprintf@PLT	#
...
# dry.c:725:   fprintf (stderr, "Enum_Loc:            %d\n", Enum_Loc);
	addl	$12, %esp	#,
	leal	.LC32@GOTOFF(%ebx), %eax	#, tmp362
...
# dry.c:735:                         / ((float) HZ * ((float) Number_Of_Runs));
	fildl	-116(%ebp)	# %sfp
# dry.c:739:     printf ("\nMicroseconds for one run through Dhrystone: ");
	leal	.LC39@GOTOFF(%ebx), %eax	#, tmp386
# dry.c:735:                         / ((float) HZ * ((float) Number_Of_Runs));
...
# dry.c:601:     printf ("Program compiled with 'register' attribute\n");
	subl	$12, %esp	#,
	leal	.LC3@GOTOFF(%ebx), %eax	#, tmp228
	pushl	%eax	# tmp228
	call	puts@PLT	#
	addl	$16, %esp	#,
	jmp	.L12	#
...
# dry.c:677:       printf ("too few\n");
	subl	$12, %esp	#,
	leal	.LC8@GOTOFF(%ebx), %eax	#, tmp253
	pushl	%eax	# tmp253
	call	puts@PLT	#
...
# dry.c:563:      printf ("Usage: %s [number of loops]\n", argv[0]);
	pushl	%eax	#
	pushl	%eax	#
	leal	.LC0@GOTOFF(%ebx), %eax	#, tmp221
